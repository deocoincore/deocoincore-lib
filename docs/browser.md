...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/deocoincore-lib.min.js"></script>
...
```sh
browserify --require ./index.js:deocoincore-lib | uglifyjs > deocoincore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external deocoincore-lib | uglifyjs > bitcore-mnemonic.min.js
```
